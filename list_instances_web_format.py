...
print tabulate(myTable, headers=["name","status","network","type","fingerprint","permissions"], tablefmt="fancy_grid")

fileContent=tabulate(myTable, headers=["name","status","network","type","fingerprint","permissions"], tablefmt="html")
#print fileContent
